...
from ruiclaw.pairing import __all__ as pairing_all
from ruiclaw.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from ruiclaw.pairing."""
    import ruiclaw.pairing as pkg
