...
from ruiclaw.webui.mcp_oauth_api import (
    McpOAuthError,
    McpOAuthManager,
...
async def test_browser_flow_retries_current_server_and_ignores_unrelated_reload_failure(
    ...
    monkeypatch.setattr(
        "ruiclaw.webui.mcp_oauth_api.validate_url_target",
        lambda _url: (True, ""),
    )
    ...
    monkeypatch.setattr("ruiclaw.webui.mcp_oauth_api.connect_mcp_servers", connect)
