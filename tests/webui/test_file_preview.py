...
from ruiclaw.security.workspace_access import default_workspace_scope
from ruiclaw.webui.file_preview import WebUIFilePreviewError, file_preview_payload
...
def test_restricted_preview_allows_media_file(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("ruiclaw.webui.file_preview.get_media_dir", lambda: media)
