...
async def test_search_marketplace_skills_filters_and_marks_installed(
    ...
    monkeypatch.setattr(
        "ruiclaw.webui.skills_marketplace.httpx.AsyncClient",
        lambda **_kwargs: FakeClient(),
    )
    monkeypatch.setattr(
        "ruiclaw.webui.skills_marketplace.skills_install_supported",
        lambda: True,
    )
...
async def test_marketplace_skill_trends_returns_history_separately(
    ...
    monkeypatch.setattr(
        "ruiclaw.webui.skills_marketplace._load_weekly_installs",
        weekly_installs,
    )
...
async def test_install_marketplace_skill_uses_official_cli_and_workspace(
    ...
    monkeypatch.setattr(
        "ruiclaw.webui.skills_marketplace.shutil.which",
        lambda executable: "/usr/local/bin/npx" if executable == "npx" else None,
    )
    monkeypatch.setattr(
        "ruiclaw.webui.skills_marketplace.asyncio.create_subprocess_exec",
