...
from ruiclaw.providers.base import GenerationSettings, LLMProvider, LLMResponse, ToolCallRequest
from ruiclaw.security.workspace_access import build_workspace_scope
...
def test_subagent_prompt_keeps_agent_paths_for_selected_project(tmp_path):
    ...
    assert f"RuiClaw's agent workspace: {agent_workspace.resolve()}" in prompt
