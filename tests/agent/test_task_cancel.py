...
from ruiclaw.bus.outbound_events import StreamDeltaEvent, StreamEndEvent
...
class TestDispatch:
    ...
    async def test_run_logs_and_continues_after_leaked_cancelled_error(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "ruiclaw.agent.loop.logger.warning",
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("ruiclaw.agent.tools.filesystem.ListDirTool.execute", fake_execute)

        from ruiclaw.agent.subagent import SubagentStatus
    ...
    async def test_cancel_by_session_cancels_running_subagent_tool(self, monkeypatch, tmp_path):
        from ruiclaw.agent.subagent import SubagentManager, SubagentStatus
        from ruiclaw.bus.queue import MessageBus
        from ruiclaw.providers.base import LLMResponse, ToolCallRequest
