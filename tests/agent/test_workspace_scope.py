...
from ruiclaw.agent.context import ContextBuilder
from ruiclaw.agent.tools.cli_apps import CliAppsTool
from ruiclaw.agent.tools.context import RequestContext, ToolContext, request_context
from ruiclaw.agent.tools.filesystem import ReadFileTool, WriteFileTool
from ruiclaw.agent.tools.image_generation import ImageGenerationError, ImageGenerationTool
from ruiclaw.agent.tools.message import MessageTool
from ruiclaw.agent.tools.search import GrepTool
from ruiclaw.agent.tools.shell import ExecTool
from ruiclaw.agent.tools.spawn import SpawnTool
from ruiclaw.apps.cli.service import CliAppManager, CliAppsRuntimeConfig
from ruiclaw.config.schema import ImageGenerationToolConfig, ProviderConfig, ToolsConfig
...
async def test_cli_app_scope_controls_working_dir(
    ...
    monkeypatch.setattr("ruiclaw.apps.cli.service.get_runtime_subdir", lambda _name: data_dir)
    monkeypatch.setattr(
