...
from ruiclaw.cli import onboard as onboard_wizard
from ruiclaw.cli.onboard import (
    _BACK_PRESSED,
...
class TestGetFieldTypeInfo:
    ...
    def test_real_provider_retry_mode_field(self):
        ...
        from ruiclaw.config.schema import AgentDefaults
...
class TestProviderChannelInfo:
    ...
    def test_get_provider_names_returns_dict(self):
        from ruiclaw.cli.onboard import _get_provider_names
    ...
    def test_get_channel_names_returns_dict(self):
        from ruiclaw.cli.onboard import _get_channel_names
    ...
    def test_get_provider_info_returns_valid_structure(self):
        from ruiclaw.cli.onboard import _get_provider_info
...
class TestValidateFieldConstraint:
    ...
    def test_returns_none_when_no_constraints(self):
        ...
        from ruiclaw.cli.onboard import _validate_field_constraint
    ...
    def test_real_send_max_retries_field(self):
        ...
        from ruiclaw.cli.onboard import _validate_field_constraint
        from ruiclaw.config.schema import ChannelsConfig
...
class TestChannelCommonRegistration:
    ...
    def test_channel_common_in_settings_sections(self):
        ...
        from ruiclaw.cli.onboard import _SETTINGS_SECTIONS
    ...
    def test_channel_common_getter_returns_channels(self):
        ...
        from ruiclaw.cli.onboard import _SETTINGS_GETTER
    ...
    def test_channel_common_setter_writes_channels(self):
        ...
        from ruiclaw.cli.onboard import _SETTINGS_SETTER
...
class TestApiServerRegistration:
    ...
    def test_api_server_setter_writes_api(self):
        ...
        config = Config()
        from ruiclaw.config.schema import ApiConfig
...
class TestMainMenuUpdate:
    ...
    def test_main_menu_hides_save_actions_until_needed(self):
        ...
        from ruiclaw.cli.onboard import _get_main_menu_choices
    ...
    def test_quick_start_openai_codex_reports_incomplete_installation(self, monkeypatch):
        ...
        assert messages == [
            "[red]This ruiclaw installation is missing the required oauth-cli-kit package. "
            "Reinstall or upgrade ruiclaw-ai using the same installation method.[/red]"
        ]
    ...
    def test_main_menu_dispatch_includes_channel_common(self):
        ...
        from ruiclaw.cli.onboard import _SETTINGS_GETTER, _SETTINGS_SECTIONS, _SETTINGS_SETTER
...
class TestIsStrOrNone:
    ...
    def test_str_or_none_true(self):
        from ruiclaw.cli.onboard import _is_str_or_none
...
class TestModelPresetWizard:
    ...
    def test_sync_preset_cache(self):
        ...
        from ruiclaw.cli.onboard import _MODEL_PRESET_CACHE, _sync_preset_cache
        from ruiclaw.config.schema import ModelPresetConfig
    ...
    def test_model_preset_add(self, monkeypatch):
        ...
        from ruiclaw.cli.onboard import _MODEL_PRESET_CACHE, _configure_model_presets
        from ruiclaw.config.schema import ModelPresetConfig
    ...
    def test_model_preset_field_handler(self, monkeypatch):
        ...
        from ruiclaw.cli.onboard import _MODEL_PRESET_CACHE, _handle_model_preset_field
        from ruiclaw.config.schema import AgentDefaults
    ...
    def test_main_menu_dispatch_includes_model_presets(self):
        ...
        from ruiclaw.cli.onboard import _configure_model_presets
    ...
    def test_fallback_models_field_add(self, monkeypatch):
        ...
        from ruiclaw.cli.onboard import _MODEL_PRESET_CACHE, _handle_fallback_models_field
        from ruiclaw.config.schema import AgentDefaults
    ...
    def test_provider_field_handler(self, monkeypatch):
        ...
        from ruiclaw.cli.onboard import _handle_provider_field
        from ruiclaw.config.schema import AgentDefaults
    ...
    def test_search_provider_field_handler(self, monkeypatch):
        ...
        from ruiclaw.agent.tools.web import WebSearchConfig
        from ruiclaw.cli.onboard import _handle_search_provider_field
