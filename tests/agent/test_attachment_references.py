...
from ruiclaw.agent.loop import AgentLoop, TurnContext, TurnKind
...
async def test_document_attachment_is_referenced_and_read_on_demand(
    ...
    csv_path.write_text("name,value\nruiclaw,1", encoding="utf-8")
    monkeypatch.setattr("ruiclaw.agent.tools.path_utils.get_media_dir", lambda: media_dir)
