...
from ruiclaw.agent.hooks import FileEditActivityHook
from ruiclaw.agent.progress_hook import AgentProgressHook
from ruiclaw.agent.runner import AgentRunner
from ruiclaw.agent.tools.filesystem import EditFileTool, WriteFileTool
...
async def test_runner_routes_hosted_tool_events_to_structured_progress():
    ...
    assert progress_text == ['search X "ruiclaw oauth"', ""]
