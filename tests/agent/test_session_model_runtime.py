...
from ruiclaw.providers.base import GenerationSettings, LLMProvider, LLMResponse
from ruiclaw.providers.factory import ProviderSnapshot
from ruiclaw.ruiclaw import RuiClaw
from ruiclaw.sdk.types import SessionSnapshot
...
async def test_streamed_sdk_resolves_session_runtime_after_lock_admission(tmp_path) -> None:
    ...
    await lock.acquire()
    try:
        run = await RuiClaw(loop).run_streamed("hello", session_key=session_key)
