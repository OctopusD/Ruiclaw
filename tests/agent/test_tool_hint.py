"""Tests for tool hint formatting (ruiclaw.utils.tool_hints)."""

from ruiclaw.providers.base import ToolCallRequest
from ruiclaw.utils.tool_hints import format_tool_hints
...
class TestToolHintKnownTools:
    ...
    def test_read_file_long_path(self):
        result = _hint([_tc("read_file", {"path": "/home/user/.local/share/uv/tools/ruiclaw/agent/loop.py"})])
    ...
    def test_exec_abbreviates_paths_in_command(self):
        ...
        cmd = "cd D:\\Documents\\GitHub\\ruiclaw\\.worktree\\tomain\\ruiclaw && git diff origin/main...pr-2706 --name-only 2>&1"
        result = _hint([_tc("exec", {"command": cmd})])
    ...
    def test_exec_abbreviates_linux_paths(self):
        ...
        cmd = "cd /home/user/projects/ruiclaw/.worktree/tomain && make build"
        result = _hint([_tc("exec", {"command": cmd})])
        assert "\u2026/" in result
    ...
    def test_exec_abbreviates_home_paths(self):
        ...
        cmd = "cd ~/projects/ruiclaw/workspace && pytest tests/"
        result = _hint([_tc("exec", {"command": cmd})])
        assert "\u2026/" in result
...
class TestToolHintMaxLength:
    ...
    def test_path_type_respects_max_length(self):
        ...
        long_path = "/home/user/.local/share/uv/tools/ruiclaw/agent/loop.py"
    ...
    def test_edit_path_respects_max_length(self):
        ...
        long_path = "/home/user/projects/ruiclaw/src/agent/loop.py"
    ...
    def test_list_dir_path_respects_max_length(self):
        ...
        long_path = "/home/user/.local/share/uv/tools/ruiclaw/"
