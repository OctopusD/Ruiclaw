...
from ruiclaw.providers.factory import ProviderSnapshot, load_provider_snapshot
from ruiclaw.session.model_selection import (
    SESSION_MODEL_PRESET_METADATA_KEY,
    model_preset_from_metadata,
)
from ruiclaw.webui.settings_api import update_agent_settings
...
def test_provider_snapshot_missing_env_reports_explicit_config_path(
    ...
    name = "RUICLAW_TEST_REFRESH_MISSING_KEY"
