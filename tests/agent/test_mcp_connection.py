...
from ruiclaw.agent.tools import mcp as mcp_runtime
from ruiclaw.agent.tools.base import Tool
from ruiclaw.agent.tools.mcp import MCPProvider, MCPResourceWrapper, MCPToolWrapper
...
async def test_connect_mcp_retries_when_no_servers_connect(tmp_path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("ruiclaw.agent.tools.mcp.connect_mcp_servers", _fake_connect)
...
async def test_connect_mcp_does_not_report_failure_before_oauth_authorization(
    ...
    connect = AsyncMock()
    monkeypatch.setattr("ruiclaw.agent.tools.mcp.connect_mcp_servers", connect)
    monkeypatch.setattr(
        "ruiclaw.agent.tools.mcp_oauth.mcp_oauth_has_credentials",
