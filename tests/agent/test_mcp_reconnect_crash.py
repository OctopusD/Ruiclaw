...
lets its idle timeout kill the session, and then exercises ruiclaw's MCP
...
from ruiclaw.agent.tools import mcp as mcp_module
from ruiclaw.agent.tools.mcp import MCPProvider, MCPToolWrapper
from ruiclaw.agent.tools.registry import ToolRegistry
from ruiclaw.config.schema import MCPServerConfig
from ruiclaw.security import network as security_network
...
def allow_loopback_mcp_urls(monkeypatch: pytest.MonkeyPatch):
    """The repro server runs on 127.0.0.1; allow ruiclaw to talk to it."""
