...
from ruiclaw.agent.goal_permission import goal_mutation_allowed, goal_mutation_permission
from ruiclaw.agent.tools.context import RequestContext
from ruiclaw.bus.events import InboundMessage
from ruiclaw.bus.outbound_events import StreamedResponseEvent
...
async def test_next_turn_after_llm_error_keeps_turn_boundary(tmp_path):
    from ruiclaw.agent.loop import AgentLoop
    from ruiclaw.agent.runner import _PERSISTED_MODEL_ERROR_PLACEHOLDER
    from ruiclaw.bus.events import InboundMessage
    from ruiclaw.bus.queue import MessageBus
