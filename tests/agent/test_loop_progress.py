...
from ruiclaw.agent.tools.filesystem import WriteFileTool
...
from ruiclaw.session.webui_turns import WebuiTurnCoordinator, WebuiTurnRoutePolicy
...
class TestToolEventProgress:
    ...
    async def test_file_edit_snapshot_skipped_when_progress_callback_cannot_emit_file_edits(
        ...
        monkeypatch.setattr(
            "ruiclaw.agent.hooks.file_edit_activity.prepare_file_edit_trackers",
    ...
    async def test_webui_title_generation_uses_turn_model_snapshot(
        ...
        monkeypatch.setattr(
            "ruiclaw.session.webui_turns.maybe_generate_webui_title_after_turn",
    ...
    async def test_webui_title_requires_inbound_opt_in(
        ...
        from ruiclaw.session.webui_turns import maybe_generate_webui_title_after_turn
