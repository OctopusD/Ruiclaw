...
from ruiclaw.channels.registry import discover_plugins, load_channel_plugin
...
def test_settings_contract_import_does_not_eagerly_load_runtime_graph() -> None:
    code = """
import sys
import ruiclaw.channels.validation

unexpected = {
    "ruiclaw.channels.manager",
    "ruiclaw.channels.websocket",
    "ruiclaw.webui.gateway_services",
} & sys.modules.keys()
