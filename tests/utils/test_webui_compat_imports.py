...
from ruiclaw.session import webui_turns
from ruiclaw.webui import thread_disk, transcript


def test_legacy_webui_utils_imports_resolve_to_new_modules() -> None:
    legacy_thread_disk = importlib.import_module("ruiclaw.utils.webui_thread_disk")
    legacy_transcript = importlib.import_module("ruiclaw.utils.webui_transcript")
    legacy_turn_helpers = importlib.import_module("ruiclaw.utils.webui_turn_helpers")
