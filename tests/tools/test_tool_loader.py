...
from ruiclaw.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_fs_tool_create_builds_from_context():
    from ruiclaw.agent.tools.filesystem import ReadFileTool
...
def test_spawn_tool_create():
    from ruiclaw.agent.tools.spawn import SpawnTool
    mock_mgr = MagicMock()
    mock_config = MagicMock()
...
def test_cron_tool_enabled_without_service():
    from ruiclaw.agent.tools.cron import CronTool
    mock_config = MagicMock()
...
def test_exec_tool_config_cls():
    from ruiclaw.agent.tools.shell import ExecTool, ExecToolConfig
...
def test_web_tools_config_cls():
    from ruiclaw.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_web_fetch_tool_create():
    from ruiclaw.agent.tools.web import WebFetchTool
    mock_config = MagicMock()
    mock_config.web.enable = True
...
def test_image_gen_tool_config_cls():
    from ruiclaw.agent.tools.image_generation import ImageGenerationTool, ImageGenerationToolConfig
...
def test_image_gen_tool_enabled():
    from ruiclaw.agent.tools.image_generation import ImageGenerationTool
    mock_config = MagicMock()
...
def test_my_tool_config_cls():
    from ruiclaw.agent.tools.self import MyTool, MyToolConfig
    assert MyTool.config_key == "my"
    assert MyTool.config_cls() is MyToolConfig


def test_my_tool_enabled():
    from ruiclaw.agent.tools.self import MyTool
    mock_config = MagicMock()
...
def test_mcp_wrappers_not_discoverable():
    from ruiclaw.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper
