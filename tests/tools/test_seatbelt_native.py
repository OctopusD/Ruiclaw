...
def layout(tmp_path, monkeypatch):
    ...
    with tempfile.TemporaryDirectory(prefix="ruiclaw-seatbelt-peer-", dir="/tmp") as peer:
        paths = {
        ...
        monkeypatch.setattr("ruiclaw.agent.tools.sandbox.get_media_dir", lambda: paths["media"])
        yield paths
