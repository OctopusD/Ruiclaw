...
from ruiclaw.agent.tools.session_messages import (
    ListSessionsTool,
...
from ruiclaw.session.session_handles import SessionHandle, SessionHandleResolver
...
async def test_reply_timeout_observes_background_delivery_failure(
    ...
    with patch("ruiclaw.agent.tools.session_messages.logger") as logger:
