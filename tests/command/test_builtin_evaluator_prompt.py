...
from ruiclaw.utils.evaluator import default_evaluator_prompt
...
async def test_evaluator_prompt_reports_default_prompt(tmp_path) -> None:
    ...
    assert "Heartbeat evaluator prompt: ruiclaw default" in out.content
...
async def test_evaluator_prompt_handles_undecodable_existing_prompt(tmp_path) -> None:
    ...
    assert "Heartbeat evaluator prompt: ruiclaw default" in status.content
