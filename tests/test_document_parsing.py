...
from ruiclaw.utils.document import (
    PdfSafetyError,
    _is_text_extension,
    extract_pdf_pages,
    extract_text,
...
class TestExtractText:
    ...
    def test_extract_text_rejects_oversized_office_archive(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("ruiclaw.utils.document._MAX_OFFICE_UNCOMPRESSED_SIZE", 16)
    ...
    def test_extract_text_stops_streaming_xlsx_at_text_limit(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("ruiclaw.utils.document._MAX_TEXT_LENGTH", 80)
    ...
    def test_extract_pdf_pages_rejects_large_content_stream(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("pypdf.PdfReader", _Reader)
        monkeypatch.setattr("ruiclaw.utils.document._MAX_PDF_CONTENT_STREAM_SIZE", 16)
