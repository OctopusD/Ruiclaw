...
async def test_openai_compat_disables_sdk_retries_by_default() -> None:
    with patch("ruiclaw.providers.openai_compat_provider.AsyncOpenAI") as mock_client:
...
def test_azure_openai_disables_sdk_retries_by_default() -> None:
    with patch("ruiclaw.providers.azure_openai_provider.AsyncOpenAI") as mock_client:
        AzureOpenAIProvider(
            api_key="sk-test",
