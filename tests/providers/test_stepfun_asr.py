...
from ruiclaw.providers.transcription import StepFunTranscriptionProvider
...
def test_stepfun_in_registry() -> None:
    ...
    assert spec.adapter == "ruiclaw.providers.transcription:StepFunTranscriptionProvider"
