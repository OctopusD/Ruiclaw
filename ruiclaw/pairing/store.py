...
Persistent storage at ``~/.ruiclaw/pairing.json`` keeps approved senders
...
def format_pairing_reply(code: str) -> str:
    ...
    return (
        "Hi! This is your private ruiclaw.\n\n"
        f"Your pairing code is: `{code}`\n\n"
        "Open the ruiclaw WebUI and enter this code to pair your chat account.\n"
