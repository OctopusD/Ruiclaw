...
This directory contains built-in skills that extend ruiclaw's capabilities.
...
When skills reference large local documentation or logs, prefer ruiclaw's built-in
