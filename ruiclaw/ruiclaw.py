"""High-level programmatic interface to ruiclaw."""
...
from ruiclaw.agent.hook import AgentHook, SDKCaptureHook
...
from ruiclaw.sdk.clients import MemoryClient, RuntimeClient, SessionClient
from ruiclaw.sdk.runtime import (
    build_process_direct_kwargs,
    ensure_single_model_selector,
)
from ruiclaw.sdk.streaming import RunStream, SDKStreamEmitter, SDKStreamingHook
from ruiclaw.sdk.types import (
...
class RuiClaw:
    """Programmatic facade for running the ruiclaw agent.
        ...
        *,
        ...
        Args:
            ...
            attributes: Optional caller-owned request data exposed to context
                ...
                from ruiclaw's trusted internal message metadata.
    ...
    async def __aenter__(self) -> RuiClaw:
        return self
