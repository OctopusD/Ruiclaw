"""OpenAI-compatible HTTP API server for a fixed ruiclaw session.
...
from ruiclaw.utils.media_decode import (
    MAX_FILE_SIZE,
)
from ruiclaw.utils.media_decode import (
...
async def handle_chat_completions(request: web.Request) -> web.Response | web.StreamResponse:
    ...
    model_name: str = _app_value(request.app, _MODEL_NAME_KEY, "model_name", "ruiclaw")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = _app_value(request.app, _MODEL_NAME_KEY, "model_name", "ruiclaw")
    return web.json_response(
        {
            "object": "list",
            "data": [
