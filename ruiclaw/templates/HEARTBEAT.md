...
<!--
This file is checked periodically by your ruiclaw agent. When ruiclaw gateway starts with gateway.heartbeat.enabled=true, it automatically registers a protected heartbeat cron job that reads this file.
