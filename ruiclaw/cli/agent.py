...
from ruiclaw import __logo__
from ruiclaw.cli.log_control import _set_ruiclaw_logs
from ruiclaw.cli.runtime_config import (
...
_CLASSIC_DEPENDENCIES = {
    "AgentLoop": ("ruiclaw.agent.loop", "AgentLoop"),
    "StreamRenderer": ("ruiclaw.cli.stream", "StreamRenderer"),
    "consume_restart_notice_from_env": (
        "ruiclaw.utils.restart",
        "consume_restart_notice_from_env",
    ),
    "is_default_workspace": ("ruiclaw.config.paths", "is_default_workspace"),
    "sync_workspace_templates": ("ruiclaw.utils.helpers", "sync_workspace_templates"),
}
...
def agent(
    ...
    logs: bool = typer.Option(
        False,
        "--logs/--no-logs",
        help="Show RuiClaw runtime logs during chat",
    ),
    ...
    if native_tui:
        from ruiclaw.cli.tui_launcher import TuiSessionError, TuiUnavailableError, launch_tui
        ...
        try:
            ...
            console.print("[dim]Use `ruiclaw agent --classic` only if you want the old prompt.[/dim]")
    ...
    from ruiclaw.cli.stream import ThinkingSpinner
    ...
    from ruiclaw.utils.helpers import sanitize_surrogates as _sanitize_surrogates
    from ruiclaw.utils.restart import (
