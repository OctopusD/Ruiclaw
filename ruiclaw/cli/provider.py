...
if TYPE_CHECKING:
    from ruiclaw.providers.registry import ProviderSpec
...
def provider_login(
    ...
    if config:
        from ruiclaw.config.loader import set_config_path
...
def _login_xai_grok() -> None:
    ...
    from ruiclaw.config.loader import load_config, resolve_config_env_vars
    from ruiclaw.providers.xai_oauth import get_xai_oauth_token, login_xai_oauth
...
def _logout_xai_grok() -> None:
    """Clear local xAI OAuth credentials for this ruiclaw instance."""
    from ruiclaw.providers.xai_oauth import get_xai_oauth_storage_path, logout_xai_oauth
...
def _login_github_copilot() -> None:
    try:
        from ruiclaw.providers.github_copilot_provider import login_github_copilot
