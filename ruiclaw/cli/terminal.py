...
from ruiclaw.cli.stream import StreamRenderer, ThinkingSpinner
...
def _init_prompt_session() -> None:
    ...
    from ruiclaw.config.paths import get_cli_history_path
...
def _print_agent_response(
    ...
    if show_header:
        console.print()
        console.print(f"[cyan]{__logo__} RuiClaw[/cyan]")
    console.print(body)
    console.print()
...
async def _print_interactive_response(
    ...
    def _write() -> None:
        ...
        def _render(target: Console) -> None:
            target.print()
            target.print(f"[cyan]{__logo__} RuiClaw[/cyan]")
