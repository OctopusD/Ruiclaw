...
from ruiclaw.config.paths import get_webui_dir
from ruiclaw.runtime_context import public_history_message
from ruiclaw.session.automation_turns import is_automation_kind
...
from ruiclaw.webui.metadata import WEBUI_MESSAGE_SOURCE_METADATA_KEY, WEBUI_TURN_METADATA_KEY
...
def replay_transcript_to_ui_messages(
    ...
    *,
    ...
    Mirrors the core fold in ``useRuiClawStream.ts`` (delta, reasoning,
