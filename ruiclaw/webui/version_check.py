"""On-demand version checker for ruiclaw-ai releases.
...
_PYPI_URL = "https://pypi.org/pypi/ruiclaw-ai/json"
...
def check_for_update() -> dict[str, Any] | None:
    ...
    try:
        ...
        logger.debug("PyPI returned an invalid ruiclaw version: %r", latest)
        return None
    return {
