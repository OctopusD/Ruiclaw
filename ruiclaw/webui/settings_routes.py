...
from ruiclaw.agent.tools.image_generation import request_image_generation_reload
from ruiclaw.agent.tools.mcp_oauth import MCP_OAUTH_CALLBACK_PATH
from ruiclaw.api.runtime import ApiRuntime, api_runtime_paths
...
from ruiclaw.pairing import approve_code, deny_code, list_pending
from ruiclaw.webui import settings_capabilities as capability_domain
from ruiclaw.webui import settings_contracts as contracts
from ruiclaw.webui import settings_models as model_domain
from ruiclaw.webui import settings_system as system_domain
from ruiclaw.webui.cli_apps_api import cli_apps_action, cli_apps_payload
from ruiclaw.webui.http_utils import http_response as _http_response
from ruiclaw.webui.http_utils import is_local_browser_request as _is_local_browser_request
from ruiclaw.webui.mcp_oauth_api import McpOAuthManager
from ruiclaw.webui.mcp_presets_api import (
    ensure_mcp_oauth_server,
    mcp_presets_settings_action,
)
from ruiclaw.webui.ruiclaw_features_api import (
    ruiclaw_feature_instance_target,
    ruiclaw_features_action,
    ruiclaw_features_payload,
)
from ruiclaw.webui.settings_api import (
...
from ruiclaw.webui.settings_contracts import (
    QueryParams,
    SettingsRequest,
    SettingsRouteResult,
)
from ruiclaw.webui.settings_runtime import runtime_config_payload
from ruiclaw.webui.settings_services import WebUISettingsServices
from ruiclaw.webui.version_check import check_for_update
...
_SYSTEM_ROUTES = {
    ...
    "/api/settings/ruiclaw-features": "features-list",
    "/api/settings/ruiclaw-features/enable": "features-enable",
    "/api/settings/ruiclaw-features/disable": "features-disable",
...
_SETTINGS_MUTATION_PATHS = frozenset({
    ...
    "/api/settings/ruiclaw-features/enable",
    "/api/settings/ruiclaw-features/disable",
...
class WebUISettingsRouter:
    ...
    def _capability_operations(
        ...
        return capability_domain.CapabilitySettingsOperations(
            ...
            ruiclaw_features_action=ruiclaw_features_action,
    ...
    def _system_operations(self) -> system_domain.SystemSettingsOperations:
        return system_domain.SystemSettingsOperations(
            ...
            ruiclaw_features_payload=ruiclaw_features_payload,
            ruiclaw_features_action=ruiclaw_features_action,
            ruiclaw_feature_instance_target=ruiclaw_feature_instance_target,
    ...
    async def _reload_mcp_runtime(self) -> dict[str, Any]:
        if self._mcp_reload is None:
            return {
                "ok": False,
                "message": "MCP runtime reload is unavailable. Restart ruiclaw to apply changes.",
        ...
        try:
            ...
            return {
                "ok": False,
                "message": "MCP hot reload timed out. Restart ruiclaw to pick up changes.",
                "requires_restart": True,
            }
            ...
            return {
                "ok": False,
                "message": "MCP hot reload failed. Restart ruiclaw to pick up changes.",
                "requires_restart": True,
                "error": str(exc),
            }
    ...
    def _ruiclaw_features_payload(self) -> dict[str, Any]:
        return ruiclaw_features_payload(config_path=self.settings.config.path)

    def _ruiclaw_features_action(
        self,
        action: str,
        query: QueryParams,
        *,
    ...
    def _handle_mcp_oauth_callback(self, request: WsRequest) -> Response:
        ...
        return self._mcp_oauth_callback_page(
            ok=True,
            message=f"Authorization received for {name}. Return to ruiclaw to finish connecting.",
        )
