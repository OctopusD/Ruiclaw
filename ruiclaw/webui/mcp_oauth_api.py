...
from ruiclaw.agent.tools.mcp import MCPConnection, connect_mcp_servers
from ruiclaw.agent.tools.mcp_oauth import MCP_OAUTH_CALLBACK_PATH, MCPOAuthHandlers
...
from ruiclaw.webui.http_utils import is_loopback_host
...
class McpOAuthManager:
    ...
    async def _connect_and_reload(
        ...
        try:
            ...
            flow.reload_result = {
                "ok": False,
                "message": "Signed in, but ruiclaw could not activate the MCP tools.",
