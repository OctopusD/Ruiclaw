...
from ruiclaw.agent.plugins import (
    AgentPlugin,
...
from ruiclaw.config.loader import load_config, resolve_config_env_vars, save_config
...
if TYPE_CHECKING:
    from ruiclaw.webui.settings_services import WebUISettingsConfig
...
def _custom_manifest(name: str, cfg: MCPServerConfig) -> dict[str, Any]:
    ...
    return app_manifest(
        app_id=name,
        display_name=name,
        description="Custom MCP server from ruiclaw config.",
        category="custom",
        source="mcp-custom",
        brand_color="#64748B",
        capabilities=[
...
async def mcp_presets_test_action(
    ...
    *,
    ...
    from ruiclaw.agent.tools.mcp import connect_mcp_servers
