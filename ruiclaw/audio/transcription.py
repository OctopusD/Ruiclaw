...
This module owns ruiclaw's transcription behavior: config resolution,
...
HTTP details; those live in ``ruiclaw.providers.transcription``.
"""
...
from ruiclaw.config.loader import resolve_env_refs
from ruiclaw.config.paths import get_media_dir
from ruiclaw.config.schema import Config, ProviderConfig
from ruiclaw.providers.registry import find_by_name
from ruiclaw.utils.media_decode import FileSizeExceeded, save_base64_data_url
