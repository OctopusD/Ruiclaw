...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: ruiclaw plugins enable matrix"
    ) from e
...
from ruiclaw.config.paths import get_data_dir, get_media_dir
...
_MXC_IMAGE_PLACEHOLDER_PREFIX = "https://ruiclaw.invalid/matrix-mxc/"
