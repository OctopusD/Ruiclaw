...
from ruiclaw.channels.registry import channel_default_enabled
...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import ruiclaw.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
...
class ChannelManager:
    ...
    def _build_channel(
        ...
        *,
        ...
        if cls.name == "websocket":
            ...
            from ruiclaw.webui.gateway_services import build_gateway_services
    ...
    def _init_channels(self) -> None:
        ...
        from ruiclaw.optional_features import ensure_enabled_channel_dependencies
