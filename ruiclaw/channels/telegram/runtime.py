...
from ruiclaw.security.network import validate_url_target
...
# python-telegram-bot exposes a six-parameter Application generic. RuiClaw
...
class TelegramChannel(BaseChannel):
    ...
    def _normalize_telegram_command(content: str) -> str:
        """Map Telegram-safe command aliases back to canonical ruiclaw commands."""
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm ruiclaw.\n\n"
    ...
    def _queue_key_for_message(message: Message) -> str:
        """Return the final ruiclaw session key used for ordered Telegram ingress."""
