...
from ruiclaw.channels.email import validation as email_validation
from ruiclaw.channels.email.manifest import SETUP_SPEC
...
def test_validate_email_blocks_private_targets_when_local_access_is_disabled(
    ...
    monkeypatch.setattr("ruiclaw.config.loader._current_config_path", config_path)
    monkeypatch.setattr(
        "ruiclaw.channels.validation.socket.create_connection",
