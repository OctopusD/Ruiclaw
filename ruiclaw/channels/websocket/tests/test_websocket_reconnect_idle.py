...
async def test_hydrate_after_subscribe_is_quiet_when_no_turn_active():
    ...
    with patch("ruiclaw.webui.session_projection.websocket_turn_wall_started_at", return_value=None):
...
async def test_hydrate_after_subscribe_pushes_running_when_turn_active():
    ...
    with (
        patch(
            "ruiclaw.webui.session_projection.websocket_turn_wall_started_at",
            return_value=1234567890.0,
        ),
        patch(
            "ruiclaw.webui.session_projection.websocket_turn_id",
