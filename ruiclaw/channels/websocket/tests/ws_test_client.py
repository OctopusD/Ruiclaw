"""Lightweight WebSocket test client for integration testing the ruiclaw WebSocket channel.

Provides an async ``WsTestClient`` class and token-issuance helpers that
integration tests can import and use directly::

    from ruiclaw.channels.websocket.tests.ws_test_client import WsTestClient
...
from ruiclaw.webui.http_utils import http_response
