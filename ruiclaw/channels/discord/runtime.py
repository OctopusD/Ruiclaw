...
from ruiclaw.utils.helpers import safe_filename, split_message
...
if DISCORD_AVAILABLE:
    ...
    class DiscordBotClient(discord.Client):
        ...
        async def send_outbound(self, msg: OutboundMessage) -> None:
            """Send a ruiclaw outbound message using Discord transport rules."""
...
class DiscordChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not DISCORD_AVAILABLE:
            self.logger.error("discord.py not installed. Run: ruiclaw plugins enable discord")
            return
