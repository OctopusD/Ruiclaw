...
from ruiclaw.channels.feishu.runtime import FeishuChannel
from ruiclaw.config import loader
from ruiclaw.config.schema import Config
from ruiclaw.pairing import store as pairing_store
...
def test_save_registration_result_reuses_existing_app_instance(monkeypatch, tmp_path):
    ...
    assert instances[0]["name"] == "ruiclaw"
