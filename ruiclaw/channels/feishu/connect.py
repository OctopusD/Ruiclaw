...
from ruiclaw.channels.feishu.instances import DEFAULT_INSTANCE_ID, validate_instance_id
...
def _default_instance_name(instance_id: str) -> str:
    return "ruiclaw" if instance_id == DEFAULT_INSTANCE_ID else f"ruiclaw {instance_id}"
