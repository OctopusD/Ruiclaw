...
from ruiclaw.channels.feishu.config import feishu_default_config
...
def _normalize_feishu_instance(
    ...
    *,
    ...
    config.setdefault("name", "ruiclaw" if instance_id == DEFAULT_INSTANCE_ID else f"ruiclaw {instance_id}")
    return config
...
def upsert_feishu_instance(
    ...
    for instance in instances:
        if instance.get("id") == instance_id or instance.get("instanceId") == instance_id:
            ...
            instance.setdefault("name", "ruiclaw" if instance_id == DEFAULT_INSTANCE_ID else f"ruiclaw {instance_id}")
            return canonical
