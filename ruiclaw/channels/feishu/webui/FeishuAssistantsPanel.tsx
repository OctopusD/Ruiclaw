...
function defaultFeishuInstance(feature: RuiClawFeatureInfo): RuiClawChannelInstanceInfo {
  return {
    id: "default",
    name: "ruiclaw",
...
function instanceDisplayName(instance: RuiClawChannelInstanceInfo): string {
