...
import ruiclaw.channels.whatsapp.runtime as whatsapp_module
from ruiclaw.bus.events import OutboundMessage
from ruiclaw.bus.queue import MessageBus
from ruiclaw.channels.whatsapp.runtime import (
    WhatsAppChannel,
...
async def test_unauthorized_dm_uses_base_pairing_flow(monkeypatch) -> None:
    _patch_neonize_api(monkeypatch)
    monkeypatch.setattr("ruiclaw.channels.base.generate_code", lambda _ch, _sid: "ABCD-EFGH")
