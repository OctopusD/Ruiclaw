...
from ruiclaw.channels.connect import ChannelConnectError, QueryParams, query_first
from ruiclaw.config.loader import load_config

if TYPE_CHECKING:
    from ruiclaw.channels.weixin.runtime import WeixinChannel
...
class WeixinConnectStore:
    ...
    async def poll(self, session_id: str, *, verify_code: str = "") -> dict[str, Any]:
        ...
        from ruiclaw.channels.weixin.runtime import MAX_QR_REFRESH_COUNT
        ...
        if status == "binded_redirect":
            ...
            return {
                "session_id": session_id,
                "status": "succeeded",
                "message": "WeChat is already connected to this ruiclaw instance.",
            }
