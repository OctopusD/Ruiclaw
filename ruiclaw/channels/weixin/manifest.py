...
from ruiclaw.channels._manifest import field, required
...
from ruiclaw.channels.weixin.state import local_state_present
from ruiclaw.channels.weixin.validation import validate
