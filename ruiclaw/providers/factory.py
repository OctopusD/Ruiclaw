...
from ruiclaw.config.schema import Config, InlineFallbackConfig, ModelPresetConfig, ProviderConfig
from ruiclaw.providers.base import GenerationSettings, LLMProvider
from ruiclaw.providers.fallback_provider import FallbackProvider
from ruiclaw.providers.registry import ProviderSpec, create_dynamic_spec, find_by_name
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "openai_codex":
        from ruiclaw.providers.openai_codex_provider import OpenAICodexProvider
        ...
        from ruiclaw.providers.xai_grok_provider import XAIGrokProvider
        ...
        from ruiclaw.providers.azure_openai_provider import AzureOpenAIProvider
        ...
        from ruiclaw.providers.anthropic_provider import AnthropicProvider
        ...
        from ruiclaw.providers.bedrock_provider import BedrockProvider
...
def load_provider_snapshot(
    ...
    *,
    ...
    from ruiclaw.config.loader import load_config, resolve_config_env_vars
