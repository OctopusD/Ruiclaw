...
from ruiclaw.events import NO_EVENTS, EventSink, RetryStatusEvent, RetryWaitEvent
from ruiclaw.utils.helpers import sanitize_surrogates_deep

if TYPE_CHECKING:
    from ruiclaw.llm_usage.models import LLMCallRecord

STREAM_IDLE_TIMEOUT_ENV = "RUICLAW_STREAM_IDLE_TIMEOUT_S"
...
class LLMProvider(ABC):
    ...
    def _observe_llm_call(
        ...
        *,
        ...
        try:
            from ruiclaw.llm_usage.context import current_llm_usage_source
            from ruiclaw.llm_usage.models import LLMCallRecord
