...
def get_oauth_model_catalog(
    ...
    *,
    ...
    if provider_name == "openai_codex":
        from ruiclaw.providers.openai_codex_provider import get_openai_codex_model_catalog

        return get_openai_codex_model_catalog(proxy)
    if provider_name == "xai_grok":
        from ruiclaw.providers.xai_grok_provider import get_xai_grok_model_catalog

        return get_xai_grok_model_catalog(proxy)
    if provider_name == "github_copilot":
        from ruiclaw.providers.github_copilot_provider import get_github_copilot_model_catalog
...
def invalidate_oauth_model_catalog(provider_name: str) -> None:
    ...
    if provider_name == "openai_codex":
        ...
        from ruiclaw.providers.xai_grok_provider import invalidate_xai_grok_model_catalog
