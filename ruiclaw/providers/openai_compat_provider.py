...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/OctopusD/Ruiclaw",
    "X-OpenRouter-Title": "ruiclaw",
...
def _openai_compat_timeout_s() -> float:
    ...
    return _float_env("RUICLAW_OPENAI_COMPAT_TIMEOUT_S", _OPENAI_COMPAT_REQUEST_TIMEOUT_S)
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply RuiClaw attribution headers to OpenRouter requests by default."""
...
class OpenAICompatProvider(LLMProvider):
                ...
                if os.environ.get("LANGFUSE_SECRET_KEY") and importlib.util.find_spec("langfuse"):
                    ...
                    if os.environ.get("LANGFUSE_SECRET_KEY"):
                        logger.warning(
                            ...
                            "run `ruiclaw plugins enable langfuse` to enable tracing"
                        )
    ...
    def _gemini_thought_signature(tool_call: dict[str, Any]) -> str | None:
        ...
        ruiclaw preserves it through the parse -> serialize round-trip so
    ...
    def _build_kwargs(
        ...
        # otherwise lets extra_body.tools replace ruiclaw's generated functions.
        if self._extra_body:
