...
class SkillsLoader:
    ...
    def _skill_aliases(self) -> dict[str, str]:
        ...
        from ruiclaw.apps.cli import CliAppManager
    ...
    def list_skills(self, filter_unavailable: bool = True) -> list[dict[str, str]]:
        ...
        """
        from ruiclaw.agent.plugins import enabled_agent_plugin_skills
    ...
    def _parse_ruiclaw_metadata(self, raw: object) -> dict[str, Any]:
        """Extract ruiclaw/openclaw metadata from a frontmatter field.
        ...
        payload = data_object.get("ruiclaw", data_object.get("openclaw", {}))
    ...
    def _get_skill_meta(self, name: str) -> dict[str, Any]:
        """Get ruiclaw metadata for a skill (cached in frontmatter)."""
        raw_meta = self.get_skill_metadata(name) or {}
        return self._parse_ruiclaw_metadata(raw_meta.get("metadata"))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        return [
            ...
            and (
                self._parse_ruiclaw_metadata(meta.get("metadata")).get("always")
                or meta.get("always")
            )
        ]
