...
class ModelRequestMetrics:
    """Content-free measurements for the exact request sent to a provider."""
...
class AgentHookContext:
    ...
    tool_governance: dict[str, dict[str, str]] = field(default_factory=dict)
    ...
    model_request: ModelRequestMetrics | None = None
...
class CompositeHook(AgentHook):
    ...
    async def before_model_call(self, context: AgentHookContext) -> None:
        await self._for_each_hook_safe("before_model_call", context)

    async def after_model_call(self, context: AgentHookContext) -> None:
        await self._for_each_hook_safe("after_model_call", context)
    ...
    async def on_model_call_error(
        ...
        await self._for_each_hook_safe("on_model_call_error", context, error)
