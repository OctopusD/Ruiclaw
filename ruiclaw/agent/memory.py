...
from ruiclaw.events import NO_EVENTS, ContextCompactionEvent, EventSink
from ruiclaw.llm_usage.context import llm_usage_source
from ruiclaw.providers.base import ProviderCallContext, ProviderConversationState
from ruiclaw.runtime_context import public_history_messages
from ruiclaw.session.manager import Session, SessionManager
from ruiclaw.session.summary import is_summary_checkpoint, session_summary_from_metadata
from ruiclaw.utils.gitstore import GitStore
...
from ruiclaw.utils.workspace_prompts import (
...
class MemoryStore:
    ...
    def build_dream_tools(self) -> ToolRegistry:
        ...
        from ruiclaw.agent.tools.filesystem import EditFileTool, ReadFileTool, WriteFileTool
        from ruiclaw.agent.tools.registry import ToolRegistry
