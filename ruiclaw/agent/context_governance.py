...
from ruiclaw.providers.conversation_state import (
...
from ruiclaw.utils.runtime import ensure_nonempty_tool_result

if TYPE_CHECKING:
    from ruiclaw.agent.tools.registry import ToolRegistry
    from ruiclaw.providers.base import LLMProvider
...
class ModelRequestState:
    ...
    last_request_compacted: bool = False
...
class ContextGovernor:
    ...
    async def prepare_request(
        ...
        *,
        ...
        state.last_request_compacted = request_was_compacted
