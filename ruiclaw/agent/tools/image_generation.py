...
from ruiclaw.agent.tools.base import Tool, ToolEffect, ToolResult, tool_parameters
...
from ruiclaw.providers.image_generation import (
    ImageGenerationError,
    ImageGenerationProvider,
    get_image_gen_provider,
    image_gen_provider_configs,
)
from ruiclaw.security.workspace_access import current_tool_workspace
from ruiclaw.security.workspace_policy import WorkspaceBoundaryError, resolve_allowed_path
from ruiclaw.utils.artifacts import (
    ArtifactError,
    generated_image_tool_result,
    store_generated_image_artifact,
)
from ruiclaw.utils.helpers import detect_image_mime

if TYPE_CHECKING:
    from ruiclaw.agent.tools.context import ToolContext
    from ruiclaw.config.schema import ProviderConfig
    ...
    def _resolve_reference_image(self, value: str) -> str:
        ...
        try:
            ...
            raise ImageGenerationError(
                "reference_images must be inside the workspace or ruiclaw media directory"
            ) from exc
...
async def reload_image_generation_tool(state: Any, registry: ToolRegistry) -> dict[str, Any]:
    ...
    return {
        "ok": True,
        "message": "Image generation settings applied without restarting ruiclaw.",
