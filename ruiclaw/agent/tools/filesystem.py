...
from ruiclaw.agent.tools.file_state import FileStates, _hash_file, current_file_states
from ruiclaw.agent.tools.path_utils import resolve_workspace_path
...
from ruiclaw.utils.helpers import build_image_content_blocks, detect_image_mime
...
class _FsTool(Tool):
    ...
    def create(cls, ctx: ToolContext) -> Tool:
        from ruiclaw.agent.skills import BUILTIN_SKILLS_DIR
    ...
    def _resolve_read(self, path: str) -> Path:
        ...
        if self._workspace is not None:
            from ruiclaw.agent.plugins import enabled_agent_plugin_skill_dirs
...
class ReadFileTool(_FsTool):
        ...
        **kwargs: Any,
        ...
        try:
            ...
            try:
                ...
                from ruiclaw.utils.document import _is_text_extension
    ...
    def _read_pdf(self, fp: Path, pages: str | None) -> str:
        from ruiclaw.utils.document import PdfPageRangeError, PdfSafetyError, extract_pdf_pages
    ...
    def _read_office_doc(
        ...
        from ruiclaw.utils.document import open_document_line_source
