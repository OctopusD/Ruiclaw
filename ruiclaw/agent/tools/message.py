...
from ruiclaw.agent.tools.context import ToolContext, current_request_context
from ruiclaw.agent.tools.path_utils import resolve_workspace_path
from ruiclaw.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
...
class MessageTool(Tool):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from ruiclaw.utils.helpers import strip_think
