...
if typing.TYPE_CHECKING:
    ...
    from ruiclaw.runtime_context import RuntimeContextProvider
...
class Schema(ABC):
    ...
    Concrete types live in :mod:`ruiclaw.agent.tools.schema`; all implement
...
class Tool(ABC):
    ...
    def effect_type(self) -> ToolEffect:
        """Coarse side-effect class used by execution policy and audit records."""
        return "read_only" if self.read_only else "unknown"
