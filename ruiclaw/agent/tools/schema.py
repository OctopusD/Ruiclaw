"""JSON Schema fragment types: all subclass :class:`~ruiclaw.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~ruiclaw.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~ruiclaw.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~ruiclaw.agent.tools.base.Schema`.
...
from ruiclaw.agent.tools.base import Schema
