...
from ruiclaw.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "ruiclaw.webui.thread_disk",
    "webui_transcript": "ruiclaw.webui.transcript",
    "webui_turn_helpers": "ruiclaw.session.webui_turns",
}
