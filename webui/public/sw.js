const CACHE_PREFIX = "ruiclaw-static-";
const CACHE_NAME = `${CACHE_PREFIX}v2`;
const ICON_CACHE_PREFIX = "ruiclaw-icons-";
...
const NETWORK_FIRST_STATIC_PATHS = new Set([
  ...
  "/manifest.json",
  ASSET_MANIFEST_PATH,
  "/brand/ruiclaw_apple_touch.png",
  "/brand/ruiclaw_favicon_32.png",
  "/brand/ruiclaw_icon_192.png",
  "/brand/ruiclaw_icon_512.png",
  "/brand/ruiclaw_icon_maskable.png",
  "/brand/ruiclaw_mark.svg",
]);
