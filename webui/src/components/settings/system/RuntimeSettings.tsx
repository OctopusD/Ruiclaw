...
import type { ApiServicePayload, RuiClawFeatureInfo, SettingsPayload } from "@/lib/types";
...
export function RuntimeSettings({
  ...
  langfuseFeature?: RuiClawFeatureInfo;
            ...
            description={
              settings.observability?.configured
                ...
                : tx(
                    ...
                    "Set LANGFUSE_SECRET_KEY and LANGFUSE_PUBLIC_KEY, then restart ruiclaw.",
                  )
            }
          >
            {capabilitiesLoading ? (
