...
export function AppsCatalogSettings({
  ...
  return (
    <div className="settings-stack">
      ...
      {requiresRestartPending ? (
        <RestartRequiredNotice
          message={tx("settings.apps.restartRequired", "Restart ruiclaw to apply updated apps and MCP tools.")}
          onRestart={onRestart}
...
function McpAppsCatalogRow({
  ...
  const statusLabel = toggleable
    ? tx("settings.ruiclawFeatures.enabled", "Enabled")
    : runtimeConnected
      ...
      <div className="group flex min-w-0 flex-wrap items-center gap-x-3 gap-y-2 px-3 py-3">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1">
          {oauthFlow ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  >
                    ...
                    {tx("settings.ruiclawFeatures.disable", "Disable")}
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            ) : (
            ...
            <AppsActionButton
              ariaLabel={tx("settings.ruiclawFeatures.enable", "Enable")}
              visibleLabel={tx("settings.ruiclawFeatures.enable", "Enable")}
              busy={enableBusy}
    ...
    case "authorization_required":
      if (completionInput === "callback_url") {
        return tx(
          ...
          "Finish signing in, then paste the callback URL into ruiclaw.",
        );
      }
      return popupBlocked
