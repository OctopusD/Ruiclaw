...
import type { ChannelRuntimeStatus, RuiClawFeatureInfo } from "@/lib/types";
...
function channelDisplayName(feature: RuiClawFeatureInfo): string {
...
export function channelIsRunning(feature: RuiClawFeatureInfo): boolean {
  return feature.runtime_status === "running";
}

export function channelToggleChecked(feature: RuiClawFeatureInfo): boolean {
...
export function channelStatusLabel(
  ...
  if (feature.configured === true) return tx("settings.ruiclawFeatures.ready", "Ready");
