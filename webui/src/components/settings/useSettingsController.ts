...
export function useSettingsController({
  ...
  const {
    ...
    mcpOAuthPopupBlocked, mcpPresetAction, mcpPresets, mcpPresetsLoading, ruiclawFeatureAction,
    ruiclawFeatureConfirm, ruiclawFeatures, ruiclawFeaturesError, ruiclawFeaturesLoading,
    ...
    setRuiClawFeatureConfirm, setRuiClawFeatures,
    setRuiClawFeaturesError,
  } = systemState;
  const featureCatalog = ruiclawFeatures?.features ?? [];
