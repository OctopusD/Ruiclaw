...
export function AboutSettings({ currentVersion }: { currentVersion?: string }) {
  const { t } = useTranslation();
  const links = [
    { key: "documentation", icon: BookOpen, href: "https://ruiclaw.wiki/" },
    { key: "sourceCode", icon: Github, href: "https://github.com/OctopusD/Ruiclaw" },
    { key: "reportIssue", icon: MessageCircle, href: "https://github.com/OctopusD/Ruiclaw/issues" },
  ];
  return (
    <div className="settings-stack">
      <div className="flex flex-col items-center gap-4 py-6 text-center">
        <img src="/brand/ruiclaw_mark.svg" alt="" className="h-16 w-16 select-none" draggable={false} />
        <h1 className="text-3xl font-semibold tracking-tight">RuiClaw</h1>
    ...
    <div className="flex flex-col items-center gap-4">
      <div className="min-w-0">
        ...
        <div className="mt-0.5 text-[12px] leading-5 text-muted-foreground">
          {currentVersion ? `v${currentVersion}` : "RuiClaw"}
        </div>
      </div>
