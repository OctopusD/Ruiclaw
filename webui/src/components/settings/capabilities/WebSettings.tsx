...
export function WebSettings({
  ...
  olostepFeature?: RuiClawFeatureInfo;
      ...
      <section>
        ...
        <SettingsGroup>
          ...
          <RestartSettingsFooter
            ...
            saveLabel={t("settings.ruiclawFeatures.installConfirmAction")}
            dirty={dirty}
            saving={saving}
            ...
            message={
              missingCredential
                ...
                : error || (!embedded && requiresRestartPending && !dirty
                  ...
                  : jinaReaderDirty
                    ? tx("settings.status.restartAfterSaving", "Save changes, then restart ruiclaw to apply them.")
                    : dirty
