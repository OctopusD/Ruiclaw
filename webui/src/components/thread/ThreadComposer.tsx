...
import type { SendAttachment, SendOptions } from "@/hooks/useRuiClawStream";
...
const SLASH_RECENTS_STORAGE_KEY = "ruiclaw.webui.slashCommandRecents";
const SLASH_RECENTS_LIMIT = 5;
const QUEUED_PROMPTS_STORAGE_PREFIX = "ruiclaw.webui.composerQueuedGuidance.v1:";
  ...
  return (
    ...
    >
      {goalPanelOpen && canExpandGoal && markdownBody ? (
        <div
          ref={panelRef}
          id="ruiclaw-goal-panel-root"
          role="dialog"
          aria-modal="false"
          aria-labelledby="ruiclaw-goal-panel-title"
          tabIndex={-1}
          className={cn(
          ...
          >
            ...
            {canExpandGoal ? (
              <button
                ...
                aria-controls={goalPanelOpen ? "ruiclaw-goal-panel-root" : undefined}
