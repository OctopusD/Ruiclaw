...
import { useRuiClawStream, type SendAttachment, type SendOptions } from "@/hooks/useRuiClawStream";
...
import type { CanonicalRunSnapshot, StreamError } from "@/lib/ruiclaw-client";
...
export function ThreadShell({
  ...
  const {
    ...
    streamError,
    dismissStreamError,
  } = useRuiClawStream(chatId, initial, hasPendingToolCalls, handleTurnEnd);
  ...
  // Persist thread to in-memory cache after paint so ``useRuiClawStream``'s chat switch
