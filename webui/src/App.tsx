...
import { RuiClawClient } from "@/lib/ruiclaw-client";
...
const SIDEBAR_STORAGE_KEY = "ruiclaw-webui.sidebar";
const SESSION_UPDATES_STORAGE_KEY = "ruiclaw-webui.sidebar.session-updates.v1";
const LEGACY_COMPLETED_RUNS_STORAGE_KEY = "ruiclaw-webui.sidebar.completed-runs.v1";
const RESTART_STARTED_KEY = "ruiclaw-webui.restartStartedAt";
const RESTART_ROUTE_KEY = "ruiclaw-webui.restartRoute";
const RESTART_ROUTE_TTL_MS = 5 * 60 * 1000;
const SIDEBAR_WIDTH = 272;
const SIDEBAR_WIDTH_STORAGE_KEY = "ruiclaw-webui.sidebar.width";
...
export default function App() {
  ...
  const refreshReadyClient = useCallback(
    async (client: RuiClawClient, fallbackSurface: RuntimeSurface) => {
