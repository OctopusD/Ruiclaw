...
describe("MessageBubble", () => {
  ...
  it("renders inline file paths as compact file references", async () => {
    ...
    const message: UIMessage = {
      ...
      role: "assistant",
      content:
        "改动在 `webui/src/components/MarkdownTextRenderer.tsx` 和 `/Users/renxubin/.ruiclaw/workspace/minecraft-fps/index.html`。",
      createdAt: Date.now(),
    };
    ...
    try {
      ...
      expect(references[1]).toHaveAttribute(
        "aria-label",
        "/Users/renxubin/.ruiclaw/workspace/minecraft-fps/index.html",
      );
