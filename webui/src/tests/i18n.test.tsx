...
const LOCALIZED_SETTINGS_COPY_KEYS = [
  ...
  "settings.ruiclawFeatures.disable",
  "settings.ruiclawFeatures.ready",
  "settings.ruiclawFeatures.missingDependency",
  "settings.ruiclawFeatures.installConfirmTitle",
  "settings.ruiclawFeatures.installConfirmDescription",
  "settings.ruiclawFeatures.installConfirmAction",
  "settings.ruiclawFeatures.channelDisabled",
  "settings.ruiclawFeatures.notEnabled",
...
const PREBOOT_SCRIPT = INDEX_HTML.match(
  /<script>\s*(\(function \(\) \{\s*var localeKey = "ruiclaw\.locale";[\s\S]*?\}\)\(\);)\s*<\/script>/,
)?.[1];
const BOOT_COPY_MARKUP = '<span data-boot-copy>Loading RuiClaw…</span>';
...
describe("webui i18n", () => {
  ...
  it("switches UI copy and document locale through the language switcher", async () => {
    ...
    expect(localStorage.getItem("ruiclaw.locale")).toBe("zh-CN");
