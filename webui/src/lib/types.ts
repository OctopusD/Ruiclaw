...
export interface RunSummary {
  ...
  total_tokens: number;
  cost_status: "estimated" | "partial" | "unknown";
...
export interface RunDetail {
  ...
  report: {
    context?: {
      ...
      max_utilization_ratio?: number | null;
      compacted_requests?: number;
      max_source_tokens?: Record<string, number>;
    };
    usage?: TurnUsage;
    cost?: {
      status: "estimated" | "partial" | "unknown";
      currency: string;
      estimated_cost_usd: number | null;
      partial_estimated_cost_usd: number | null;
      pricing_snapshot_id: string;
      pricing_captured_at: string;
      pricing_source_url: string;
      pricing_scope: string;
      basis: "provider_calls" | "logical_model_calls";
...
export interface RuiClawFeatureInfo {
  name: string;
  display_name: string;
  capabilities?: string[];
...
export interface RuiClawChannelInstanceInfo {
  id: string;
  name: string;
  display_name?: string;
  avatar_url?: string;
...
export interface RuiClawFeaturesPayload {
  features: RuiClawFeatureInfo[];
...
export interface ChannelConnectPayload {
  ...
  ruiclaw_features?: RuiClawFeaturesPayload;
}
