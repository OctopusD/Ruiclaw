# Build a QQ AI Agent with ruiclaw

This guide connects ruiclaw to QQ through the official `qq` channel. The
...
- the `qq` channel enabled in ruiclaw
...
snippet into `~/.ruiclaw/config.json`:
