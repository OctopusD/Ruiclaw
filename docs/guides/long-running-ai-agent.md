# How to Run a Long-Running AI Agent with ruiclaw

ruiclaw can keep agent work alive across turns through sustained goals,
...
so ruiclaw can link it to the correct session and workspace.
